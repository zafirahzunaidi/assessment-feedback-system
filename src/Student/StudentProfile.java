...
public class StudentProfile extends javax.swing.JFrame {
    ...
    private void loadProfilePage() {
        ...
        // load from student.txt
        StudentRow s = findStudentById(studentId);
        if (s == null) {
            JOptionPane.showMessageDialog(this, "Student not found in student.txt: " + studentId);
            return;
        }
        ...
        tfCourse.setText(s.course);
        tfUsername.setText(s.username);

        // load password from user.txt
        String password = findPasswordByUsername(s.username);
    ...
    private String findPasswordByUsername(String username) {
        ...
        try (BufferedReader br = Files.newBufferedReader(Paths.get(FilePath.USER_FILE))) {
            ...
            while ((line = br.readLine()) != null) {
                ...
                String fileUsername = p[0].trim();
                String filePassword = p[1].trim();
    ...
    private void initComponents() {
        ...
        lblCourseText.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        lblCourseText.setForeground(new java.awt.Color(102, 102, 102));
        lblCourseText.setText("Current Course");

        tfCourse.setEditable(false);
        tfCourse.setBackground(new java.awt.Color(255, 255, 255));
        tfCourse.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        tfCourse.setText("jTextField1");
        tfCourse.setFocusable(false);
        tfCourse.addActionListener(this::tfCourseActionPerformed);

        lblLoginDetails.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        ...
        btnUpdateProfile.setBackground(new java.awt.Color(204, 222, 125));
        btnUpdateProfile.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        btnUpdateProfile.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/MPIconUpdateProfile.png"))); // NOI18N
        btnUpdateProfile.setText("Update Profile   ");
        btnUpdateProfile.setBorder(javax.swing.BorderFactory.createEtchedBorder(javax.swing.border.EtchedBorder.RAISED));
        btnUpdateProfile.setBorderPainted(false);
        btnUpdateProfile.setFocusPainted(false);
        btnUpdateProfile.setHorizontalTextPosition(javax.swing.SwingConstants.LEADING);
        btnUpdateProfile.setIconTextGap(-10);
        btnUpdateProfile.setOpaque(true);
        btnUpdateProfile.addActionListener(this::btnUpdateProfileActionPerformed);

        btnChangePassword.setBackground(new java.awt.Color(204, 222, 125));
        btnChangePassword.setFont(new java.awt.Font("Arial", 1, 12)); // NOI18N
        btnChangePassword.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/MPButtonChangePassword.png"))); // NOI18N
        ...
        btnChangePassword.setHorizontalTextPosition(javax.swing.SwingConstants.LEADING);
        btnChangePassword.setIconTextGap(-13);
        ...
        contentLayout.setHorizontalGroup(
            ...
            .addGroup(contentLayout.createSequentialGroup()
                ...
                .addGroup(contentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lblUsernameText, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(contentLayout.createSequentialGroup()
                        .addGroup(contentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(tfCourse, javax.swing.GroupLayout.PREFERRED_SIZE, 324, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(contentLayout.createSequentialGroup()
                        .addGroup(contentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(btnUpdateProfile, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(tfUsername, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 324, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(contentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(contentLayout.createSequentialGroup()
                                .addGap(20, 20, 20)
                            ...
                            .addGroup(contentLayout.createSequentialGroup()
                                ...
                                .addGroup(contentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(pfPassword, javax.swing.GroupLayout.PREFERRED_SIZE, 324, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                    .addGroup(contentLayout.createSequentialGroup()
                        .addComponent(lblNameText, javax.swing.GroupLayout.PREFERRED_SIZE, 100, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(242, 242, 242)
                        .addGroup(contentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(lblCourseText, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        contentLayout.setVerticalGroup(
            ...
            .addGroup(contentLayout.createSequentialGroup()
                ...
                .addGap(20, 20, 20)
                .addComponent(lblCourseText, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(10, 10, 10)
                .addComponent(tfCourse, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(30, 30, 30)
                .addComponent(lblLoginDetails, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(30, 30, 30)
    ...
    private void btnUpdateProfileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateProfileActionPerformed
        StudentUpdateProfile f = new StudentUpdateProfile();
